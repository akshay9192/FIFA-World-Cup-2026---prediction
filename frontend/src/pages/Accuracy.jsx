      ...
      <section className="page-shell accuracy-story">
        <AsyncState loading={loading} error={!data ? error : ''} empty={!accuracy} onRetry={retry}>
          {accuracy && <>
            ...
            <AccuracyLine history={accuracy.history} />
  ...
  return (
    <figure className="accuracy-chart">
      ...
      <svg viewBox="0 0 920 300" role="img" aria-labelledby="accuracy-chart-title" aria-describedby="accuracy-chart-desc">
        ...
        <polyline points={points} /><line className="axis" x1="48" x2="872" y1="244" y2="244" /><text x="48" y="274">MATCH 01</text><text x="872" y="274" textAnchor="end">MATCH {String(history.length).padStart(2, '0')}</text>
      </svg>
    </figure>
  );
}
